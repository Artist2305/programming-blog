...
export const NavContainer = styled.div(({ menuState }) => [tw`shadow-md h-96 z-50 w-full flex absolute
justify-between mb-10 p-3 lg:(bg-transparent)`, menuState === 'open' ? tw`h-96` : tw`h-20`]);
