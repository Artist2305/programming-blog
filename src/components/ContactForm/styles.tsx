...
export const ContactWrapper = tw.div`flex flex-col w-full justify-center content-center`;
...
export const Input = tw.input`text-gray-800 mx-auto text-base font-sans bg-gray-100 shadow outline-none  w-56 sm:(w-full h-9 p-3)`;
export const MessageInput = tw.textarea`text-gray-800 mx-auto sm:(w-full h-56 p-3 mb-0) w-56 bg-gray-100 shadow outline-none text-base font-sans`;
...
export const Button = tw.button`text-gray-800 duration-300 outline-none bg-gray-300 px-10 py-2 mt-3 rounded ml-auto mr-auto shadow font-semibold
active:(outline-none)
focus:(outline-none)
hover:(bg-gray-400)`;
